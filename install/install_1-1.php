	...
	public function insert_calendar_holidays()
	{
		return $this->db->insert('ignore',
			...
			array(
				...
				array('Mother\'s Day', '2010-05-09'),
				array('Mother\'s Day', '2011-05-08'),
				array('Mother\'s Day', '2012-05-13'),
				array('Mother\'s Day', '2013-05-12'),
				array('Mother\'s Day', '2014-05-11'),
				array('Mother\'s Day', '2015-05-10'),
				array('Mother\'s Day', '2016-05-08'),
				array('Mother\'s Day', '2017-05-14'),
				array('Mother\'s Day', '2018-05-13'),
				array('Mother\'s Day', '2019-05-12'),
				array('Mother\'s Day', '2020-05-10'),
				array('Father\'s Day', '2008-06-15'),
				array('Father\'s Day', '2009-06-21'),
				array('Father\'s Day', '2010-06-20'),
				array('Father\'s Day', '2011-06-19'),
				array('Father\'s Day', '2012-06-17'),
				array('Father\'s Day', '2013-06-16'),
				array('Father\'s Day', '2014-06-15'),
				array('Father\'s Day', '2015-06-21'),
				array('Father\'s Day', '2016-06-19'),
				array('Father\'s Day', '2017-06-18'),
				array('Father\'s Day', '2018-06-17'),
				array('Father\'s Day', '2019-06-16'),
				array('Father\'s Day', '2020-06-21'),
				array('Summer Solstice', '2010-06-21'),
				array('Summer Solstice', '2011-06-21'),
				array('Summer Solstice', '2012-06-20'),
				array('Summer Solstice', '2013-06-21'),
				array('Summer Solstice', '2014-06-21'),
				array('Summer Solstice', '2015-06-21'),
				array('Summer Solstice', '2016-06-20'),
				...
				array('Vernal Equinox', '2010-03-20'),
				array('Vernal Equinox', '2011-03-20'),
				array('Vernal Equinox', '2012-03-20'),
				array('Vernal Equinox', '2013-03-20'),
				array('Vernal Equinox', '2014-03-20'),
				array('Vernal Equinox', '2015-03-20'),
				array('Vernal Equinox', '2016-03-19'),
				...
				array('Winter Solstice', '2010-12-21'),
				array('Winter Solstice', '2011-12-22'),
				array('Winter Solstice', '2012-12-21'),
				array('Winter Solstice', '2013-12-21'),
				array('Winter Solstice', '2014-12-21'),
				array('Winter Solstice', '2015-12-21'),
				array('Winter Solstice', '2016-12-21'),
				...
				array('Autumnal Equinox', '2010-09-22'),
				array('Autumnal Equinox', '2011-09-23'),
				array('Autumnal Equinox', '2012-09-22'),
				array('Autumnal Equinox', '2013-09-22'),
				array('Autumnal Equinox', '2014-09-22'),
				array('Autumnal Equinox', '2015-09-23'),
				array('Autumnal Equinox', '2016-09-22'),
				...
				array('Independence Day', '0004-07-04'),
				array('Cinco de Mayo', '0004-05-05'),
				array('Flag Day', '0004-06-14'),
				array('Veterans Day', '0004-11-11'),
				array('Groundhog Day', '0004-02-02'),
				array('Thanksgiving', '2010-11-25'),
				array('Thanksgiving', '2011-11-24'),
				array('Thanksgiving', '2012-11-22'),
				array('Thanksgiving', '2013-11-28'),
				array('Thanksgiving', '2014-11-27'),
				array('Thanksgiving', '2015-11-26'),
				array('Thanksgiving', '2016-11-24'),
				array('Thanksgiving', '2017-11-23'),
				array('Thanksgiving', '2018-11-22'),
				array('Thanksgiving', '2019-11-28'),
				array('Thanksgiving', '2020-11-26'),
				array('Memorial Day', '2010-05-31'),
				array('Memorial Day', '2011-05-30'),
				array('Memorial Day', '2012-05-28'),
				array('Memorial Day', '2013-05-27'),
				array('Memorial Day', '2014-05-26'),
				array('Memorial Day', '2015-05-25'),
				array('Memorial Day', '2016-05-30'),
				array('Memorial Day', '2017-05-29'),
				array('Memorial Day', '2018-05-28'),
				array('Memorial Day', '2019-05-27'),
				array('Memorial Day', '2020-05-25'),
				array('Labor Day', '2010-09-06'),
				array('Labor Day', '2011-09-05'),
				array('Labor Day', '2012-09-03'),
				array('Labor Day', '2013-09-02'),
				array('Labor Day', '2014-09-01'),
				array('Labor Day', '2015-09-07'),
				array('Labor Day', '2016-09-05'),
