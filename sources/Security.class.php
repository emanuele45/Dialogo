...
class Security
{
	 ...
	 */
	public function validateSession($type = 'admin')
	{
	 ...
	 */
	public function is_not_guest($message = '', $is_fatal = true)
	{
	 ...
	 */
	public function is_not_banned($forceCheck = false)
	{
	 ...
	 */
	public function checkSession($type = 'post', $from_action = '', $is_fatal = true)
	{
	 ...
	 * @param string $action
	 */
	public function checkConfirm($action)
	{
		global $modSettings;
	 ...
	 */
	public function createToken($action, $type = 'post')
	{
	 ...
	 */
	public function validateToken($action, $type = 'post', $reset = true, $fatal = true)
	{
	 ...
	 */
	public function cleanTokens($complete = false, $suffix = '')
	{
	 ...
	 * @param bool $is_fatal = true
	 */
	public function checkSubmitOnce($action, $is_fatal = true)
	{
		global $context;
	 ...
	 */
	public function allowedTo($permission, $boards = null)
	{
		global $user_info;
	 ...
	 */
	public function isAllowedTo($permission, $boards = null)
	{
	 ...
	 */
	public function boardsAllowedTo($permissions, $check_access = true, $simple = true)
	{
		global $user_info;
	 ...
	 */
	public function spamProtection($error_type, $fatal = true)
	{
	 ...
	 */
	public function validatePasswordFlood($id_member, $password_flood_value = false, $was_correct = false)
	{
		global $cookiename;
