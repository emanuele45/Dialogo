			...
			if (!empty($context['can_quick_mod']))
			{
				...
				else
				{
					...
					if ($topic['quick_mod']['move'])
						echo '<a href="', $scripturl, '?action=topic;sa=move;current_board=', $context['current_board'], ';board=', $context['current_board'], '.', $context['start'], ';topic=', $topic['id'], '.0"><img src="', $settings['images_url'], '/icons/quick_move.png" style="width:16px" alt="', $txt['move_topic'], '" title="', $txt['move_topic'], '" /></a>';
				}
